...
def derivative_of_dcg_currents(v_dcg, i_dcg, 
    ...
    f_dcg = -bistable_fn(v_dcg, v_c)

    # rv = rho_of_s * f_dcg - gamma * rho_of_oms * i_dcg
    rv = q * rho_of_oms * f_dcg - gamma * rho_of_s * i_dcg
...
def test_simple_system():
    ...
    for i in xrange(2 * 1000):
        ...
        d_i_dcg = derivative_of_dcg_currents(v_dcg, i_dcg, s, delta_s=1e-3, gamma=1.0, q=1.0, v_c=10.0)
